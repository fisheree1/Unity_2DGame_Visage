...
public class DadP : MonoBehaviour
{
    ...
    {
        // 如果已死亡，只允许转换到死亡状态
        if (enemyLife != null && enemyLife.IsDead && type != DadStateType.Dead)
        {
            Debug.LogWarning($"Dad: Attempted to transition to {type} while dead. Ignoring.");
            return;
        }
    ...
    {
        Debug.Log("Dad object is being destroyed");
    }
}
